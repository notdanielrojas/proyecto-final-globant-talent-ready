...
Call log:
  - Expect "toHaveURL" with timeout 15000ms
    30 × locator resolved to <html lang="en">…</html>
...
- main:
  ...
  - textbox "Nombre o Razón Social *":
    ...
    - text: Kerluke, Lueilwitz and Runte
  - text: Retiene IVA
...
```ts
  ...
  14 | 
  15 |     // Validar redirección directa a la URL del listado
> 16 |     await expect(clientsPage.page).toHaveURL("https://imcoarca.leonardojose.dev/clientes", {
     |                                    ^ Error: expect(page).toHaveURL(expected) failed
  17 |       timeout: 15000,
  18 |     });
  19 |   });

              ...
              - generic [ref=e271]:
                ...
                - generic [ref=e312]:
                  ...
                  - textbox "Email" [ref=e315]:
                    - /placeholder: Uno o varios, separados por coma o espacio
                    - text: Romaine.Bailey52@yahoo.com
                - generic [ref=e316]:
...
```ts
  ...
  13 | 
> 14 |     expect(response.id).toBeGreaterThan(0);
     |                         ^ Error: expect(received).toBeGreaterThan(expected)
  15 |     expect(response.customerCode).toBeTruthy();
  16 |   });
  17 | });
```
...
- Name: createPayment.spec.ts >> Módulo de Cobranzas >> Debe permitir registrar una cobranza especificando un medio de pago puntual (Override)
- Location: tests\createPayment.spec.ts:23:3
...
- generic [ref=f1e2]:
  - generic [ref=f1e4]:
    - img "Logo ERP" [ref=f1e6]
    - generic [ref=f1e7]:
      - generic [ref=f1e8]:
        - generic [ref=f1e9]: Email
        - textbox "Email" [ref=f1e10]
      - generic [ref=f1e11]:
        - generic [ref=f1e12]: Contraseña
        - textbox "Contraseña" [ref=f1e13]
      - link "¿Olvidaste tu contraseña?" [ref=f1e15] [cursor=pointer]:

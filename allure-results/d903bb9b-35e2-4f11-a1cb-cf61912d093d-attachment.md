              ...
              - generic [ref=e271]:
                ...
                - generic [ref=e312]:
                  ...
                  - textbox "Email" [ref=e315]:
                    - /placeholder: Uno o varios, separados por coma o espacio
                    - text: Kasey_Rutherford37@gmail.com
                - generic [ref=e316]:
...
```ts
  ...
  13 | 
  14 |     const response = await clientsPage.saveChangesAndGetClientCode();
  15 | 
  16 |     // Validamos únicamente que se haya asignado y capturado el código de cliente
> 17 |     expect(response.customerCode).toBeTruthy();
     |                                   ^ Error: expect(received).toBeTruthy()
  18 |   });
  19 | });
```
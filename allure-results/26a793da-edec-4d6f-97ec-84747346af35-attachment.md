              ...
              - generic [ref=e271]:
                ...
                - generic [ref=e312]:
                  ...
                  - textbox "Email" [ref=e315]:
                    - /placeholder: Uno o varios, separados por coma o espacio
                    - text: Elmer.Schaden@hotmail.com
                - generic [ref=e316]:
              ...
              - generic [ref=e334]:
                ...
                - generic [ref=e363]:
                  ...
                  - combobox "Pedir Constancia de IVA" [ref=e366]:
                    ...
                    - option "Si"
            - generic [ref=e369]:
              - button "Volver" [ref=e370]
              - button "Guardar Cambios" [ref=e371]
...
```ts
  ...
  9  | 
  10 |     await clientsPage.fillForm(clientData);
  11 | 
  12 |     const response = await clientsPage.saveChangesAndGetClientCode();
  13 | 
> 14 |     expect(response.id).toBeDefined();
     |                         ^ Error: expect(received).toBeDefined()
  15 |     expect(Number(response.id)).toBeGreaterThan(0);
  16 |     expect(response.customerCode).toBeTruthy();
  17 |   });
  18 | });
  19 | 
```
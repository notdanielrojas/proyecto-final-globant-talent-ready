...
Call log:
  - waiting for getByLabel('Código (SKU) *', { exact: true })
        ...
        - list [ref=e10]:
          ...
          - listitem [ref=e32]:
            - generic [ref=e33]:
              ...
              - list [ref=e40]:
                - listitem [ref=e41]:
                  - link "Artículos" [active] [ref=e42] [cursor=pointer]:
                    - /url: /articulos
                - listitem [ref=e47]:
                  - link "Publicaciones ML" [ref=e48] [cursor=pointer]:
                    - /url: /mercadolibre-publicaciones
                - listitem [ref=e53]:
                  - link "Transportes" [ref=e54] [cursor=pointer]:
                    - /url: /transportes
                - listitem [ref=e59]:
                  - link "Movimientos de Stock" [ref=e60] [cursor=pointer]:
                    - /url: /stock/movimientos
                - listitem [ref=e65]:
                  - link "Fraccion/Impresión" [ref=e66] [cursor=pointer]:
          ...
          - listitem [ref=e87]:
            - link "Reportes" [ref=e88] [cursor=pointer]:
              - /url: /reportes
...
```ts
  ...
  16 |     this.page = page;
  17 |     this.skuInput = page.getByLabel('Código (SKU) *', { exact: true })

...
- main:
  ...
  - textbox "Nombre o Razón Social *":
    ...
    - text: Mraz - Runolfsson-Jakubowski
  - text: Retiene IVA
...
```ts
  ...
  11 | 
  12 |     // Validar redirección o permanencia en la ruta de clientes
> 13 |     await expect(clientsPage.page).toHaveURL("https://imcoarca.leonardojose.dev/clientes", {
     |                                    ^ Error: expect(page).toHaveURL(expected) failed
  14 |       timeout: 15000,
  15 |     });
  16 |   });

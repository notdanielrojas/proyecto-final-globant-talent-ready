...
Locator: locator('tr').filter({ hasText: '00057' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('tr').filter({ hasText: '00057' })
...
- main:
  ...
  - table:
    - rowgroup:
      - row "ID Nº Recibo Fecha Cliente Monto Total Estado Acciones":
        - columnheader "ID":
          - button "ID":
            - text: ID
            - img
        - columnheader "Nº Recibo":
          - button "Nº Recibo":
            - text: Nº Recibo
            - img
        - columnheader "Fecha":
    ...
    - rowgroup:
      - row "300392 5 05/09/2026 Goyette - Welch $ 354.025,00 Activa":
        - cell "300392"
        - cell "5"
        - cell "05/09/2026"
        - cell "Goyette - Welch"
        ...
        - cell:
          ...
          - button "Eliminar":
            - img
      - row "300396 6 05/09/2026 Goyette - Welch $ 254.638,00 Activa":
        - cell "300396"
        - cell "6"
        - cell "05/09/2026"
        - cell "Goyette - Welch"
        ...
        - cell:
          ...
          - button "Eliminar":
            - img
      - row "300397 6 05/09/2026 Goyette - Welch $ 388.724,00 Activa":
        - cell "300397"
        - cell "6"
        - cell "05/09/2026"
        - cell "Goyette - Welch"
        ...
        - cell:
          ...
          - button "Eliminar":
            - img
      - row "300398 7 05/09/2026 Goyette - Welch $ 269.916,00 Activa":
        - cell "300398"
        - cell "7"
        - cell "05/09/2026"
        - cell "Goyette - Welch"
        ...
        - cell:
          ...
          - button "Eliminar":
            - img
      - row "300399 8 05/09/2026 Goyette - Welch $ 388.848,00 Activa":
        - cell "300399"
        - cell "8"
        - cell "05/09/2026"
        - cell "Goyette - Welch"
        ...
        - cell:
          ...
          - button "Eliminar":
            - img
      - row "300400 9 05/09/2026 Goyette - Welch $ 295.708,00 Activa":
        - cell "300400"
        - cell "9"
        - cell "05/09/2026"
        - cell "Goyette - Welch"
        ...
        - cell:
          ...
          - button "Eliminar":
            - img
      - row "300401 10 05/09/2026 Goyette - Welch $ 19.334,00 Activa":
        - cell "300401"
        - cell "10"
        - cell "05/09/2026"
        - cell "Goyette - Welch"
...
```ts
  ...
  44 |     const filaCobranza = page.locator("tr", {
  45 |       hasText: paymentData.clienteCodigo,
  46 |     });
  47 | 
  48 |     // 6. Asertar que la fila exista en la tabla
> 49 |     await expect(filaCobranza).toBeVisible();
     |                                ^ Error: expect(locator).toBeVisible() failed
  50 | 
  51 |     // 7. Hacer clic en la fila o en la acción correspondiente
  52 |     await filaCobranza.click();
  53 |   });
  54 | });
```
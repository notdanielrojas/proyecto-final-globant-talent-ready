...
Call log:
  - Expect "toHaveURL" with timeout 20000ms
    35 × locator resolved to <html lang="en">…</html>
...
- main:
  ...
  - textbox "Email":
    ...
    - text: Jaunita_Stamm69@gmail.com
...
```ts
  ...
  6  |     const CLIENT_URL = process.env.CLIENT_URL!;
  7  | 
  ...
  15 | 
> 16 |     await expect(clientsPage.page).toHaveURL(CLIENT_URL, {
     |                                    ^ Error: expect(page).toHaveURL(expected) failed
  17 |       timeout: 20000,
  18 |     });
  19 |   });

              ...
              - generic [ref=e142]:
                ...
                - generic [ref=e152]:
                  ...
                  - textbox "Nombre o Razón Social *" [ref=e155]:
                    ...
                    - text: Quitzon-Gislason, Doyle and Hackett-Goodwin
                - generic [ref=e156]:
              ...
              - generic [ref=e271]:
                ...
                - generic [ref=e312]:
                  ...
                  - textbox "Email" [ref=e315]:
                    - /placeholder: Uno o varios, separados por coma o espacio
                    - text: Rosalinda_Schinner@gmail.com
                - generic [ref=e316]:
...
```ts
  ...
  68 | 
  69 |   async saveChangesAndGetClientCode(): Promise<CreatedClientResponse> {
  70 |     const [response] = await Promise.all([
> 71 |       this.page.waitForResponse(
     |                 ^ Error: page.waitForResponse: Test timeout of 30000ms exceeded.
  72 |         (res) => res.url().includes("/api/clients") && res.request().method() === "POST" && (res.status() === 200 || res.status() === 201),
  73 |       ),
  74 |       this.guardarCambiosButton.click(),
  75 |     ]);
  76 | 
  77 |     const responseJson = await response.json();
  78 |     const data = responseJson.data || responseJson;
  79 | 
  80 |     return {
  81 |       id: Number(data.id),
  82 |       customerCode: data.customer_code,
  83 |     };
  84 |   }
  85 | }
  86 | 
